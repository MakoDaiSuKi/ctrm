...
public interface EstPremiumSetupService {
	ActionResult<EstPremiumSetup> Save(EstPremiumSetup estPremiumSetup);
	ActionResult<String> Delete(String guid);
	ActionResult<EstPremiumSetup> GetById(String id);
	ActionResult<List<EstPremiumSetup>> EstPremiumSetups();
